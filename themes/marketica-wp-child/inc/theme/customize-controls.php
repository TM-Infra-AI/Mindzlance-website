...
class TokoPress_Customize_Number_Control extends WP_Customize_Control {
	public $type = 'tokopress-number';
...
class TokoPress_Customize_Color_Control extends WP_Customize_Control {
	...
	protected function content_template() {
		...
		<input class="tokopress-color-control" type="text" data-show-opacity="{{ data.show_opacity }}" data-palette="{{ data.palette }}" data-default-color="{{ data.default }}" value="{{ data.value }}" {{{ data.link }}} />
		<?php
	}
}
...
class TokoPress_Customize_Radio_Iconset_Control extends WP_Customize_Control {
	public $type = 'tokopress-radio-iconset';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class TokoPress_Customize_Select2_Multiple_Control extends WP_Customize_Control {
	public $type = 'tokopress-select2-multiple';
	public function to_json() {
		parent::to_json();
...
class TokoPress_Customize_GoogleFonts_Control extends WP_Customize_Control {
	public $type = 'tokopress-googlefonts';
	public function to_json() {
		parent::to_json();
		$this->json['value']   = $this->value();
		$this->json['choices'] = $this->choices;
...
class TokoPress_Customize_Sortable_Control extends WP_Customize_Control {
	public $type = 'tokopress-sortable';
	public function to_json() {
		parent::to_json();
		$this->json['default'] = $this->setting->default;
		if ( isset( $this->default ) ) {
	...
	protected function content_template() {
		?>
		<label class='tokopress-sortable'>
			...
			<ul class="sortable">
				<# _.each( data.value, function( choiceID ) { #>
					<li {{{ data.inputAttrs }}} class='tokopress-sortable-item' data-value='{{ choiceID }}'>
				...
				<# _.each( data.choices, function( choiceLabel, choiceID ) { #>
					<# if ( -1 === data.value.indexOf( choiceID ) ) { #>
						<li {{{ data.inputAttrs }}} class='tokopress-sortable-item invisible' data-value='{{ choiceID }}'>
							<i class='dashicons dashicons-menu'></i>
							<i class="dashicons dashicons-visibility visibility"></i>
							{{{ data.choices[ choiceID ] }}}
						</li>
