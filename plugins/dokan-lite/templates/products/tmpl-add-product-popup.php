        ...
        <form action="" method="post" id="dokan-add-new-product-form">
            <div class="product-form-container">
                        ...
                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                            <div class="content-half-part">
                                ...
                                <div class="dokan-input-group">
                                    ...
                                    <input type="number" id="_regular_price" onfocusout="cregularprice()" class="dokan-product-regular-price dokan-form-control" name="_regular_price" placeholder="0.00" min="0" step="any">
                                </div>
                            </div>
                            ...
                            <div class="content-half-part sale-price">
                                ...
                                <div class="dokan-input-group">
                                    <span class="dokan-input-group-addon"><?php echo esc_html( get_woocommerce_currency_symbol() ); ?></span>
                                    <input type="number" onfocusout="csaleprice()" class="dokan-product-sales-price dokan-form-control" id="_sale_price" name="_sale_price" placeholder="0.00" min="0" step="any">
                                </div>
                            </div>
                        </div>
                ...
                <div class="product-full-container">
                    ...
                    <div class="dokan-form-group">
                        <textarea  required="required" name="post_excerpt" id="" class="dokan-form-control" rows="5" placeholder="<?php esc_attr_e( 'Enter some short description about this product...' , 'dokan-lite' ) ?>"></textarea>
                    </div>
                </div>
            </div>
