                        ...
                        <form class="dokan-form-container" method="post">
                            ...
                            <div class="product-edit-container dokan-clearfix">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        <textarea name="post_excerpt" id="post-excerpt" required rows="5" class="dokan-form-control" placeholder="<?php esc_attr_e( 'Short description of the product...', 'dokan-lite' ); ?>"><?php echo esc_attr( dokan_posted_textarea( 'post_excerpt' ) ); ?></textarea>
                                    </div>
