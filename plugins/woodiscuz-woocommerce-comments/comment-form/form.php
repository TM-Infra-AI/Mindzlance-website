...
<div id="woopcomm">
    ...
    <div class="wpc-form-wrapper">
                            ...
                            <?php if (!is_user_logged_in()) { ?>
                                <div class="wpc-field-captcha woodiscuz-item">
                                    ...
                                    <span class="wpc-label wpc-captcha-label">
                                        <img src="<?php echo plugins_url(WOODISCUZ_DIR_NAME . '/captcha/captcha.php?comm_id=' . $post->ID . '-' . 0); ?>" id="wpc_captcha_img-<?php echo $unique_id; ?>" />
                                        <img src="<?php echo plugins_url(WOODISCUZ_DIR_NAME . '/files/img/refresh-16x16.png'); ?>" id="wpc_captcha_refresh_img-<?php echo $unique_id; ?>" class="wpc_captcha_refresh_img" />
                                    </span>
        ...
        <input type="hidden" name="wpc_plugin_dir_url" value="<?php echo WOODISCUZ_DIR_NAME; ?>" id="wpc_plugin_dir_url" />
    </div>
    <hr/>
    ...
    <?php if ($this->wpc_options_serialized->wpc_show_plugin_powered_by) { ?>
        <div class="by-woodiscuz"><span id="awoodiscuz" onclick='javascript:document.getElementById("bywoodiscuz").style.display = "inline";
                document.getElementById("awoodiscuz").style.display = "none";'><img src="<?php echo plugins_url(WOODISCUZ_DIR_NAME . '/files/img/plugin-icon/icon_info.png'); ?>" align="absmiddle" class="woodimg"/></span>&nbsp;<a href="http://woodiscuz.com/" id="bywoodiscuz" title="WooDIscuz v<?php echo get_option($this->woodiscuz_version); ?>- Interactive Comment System for eCommerce Platforms">WooDiscuz</a>
        </div>
    <?php } ?>
    <div id="wpc_openModalFormAction" class="modalDialog">
        <div id="wpc_response_info" class="wpc_modal">
            <div id="wpc_response_info_box">
                ...
                <img width="64" height="64" src="<?php echo plugins_url(WOODISCUZ_DIR_NAME . '/files/img/loader/ajax-loader-200x200.gif'); ?>" />
            </div>
        </div>
    </div>
</div>