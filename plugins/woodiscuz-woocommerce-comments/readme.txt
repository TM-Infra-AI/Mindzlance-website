...
= WooDiscuz - WooCommerce Comments v2.2.9 =

* Added: New options for badges colors

= WooDiscuz - WooCommerce Comments v2.2.8 =

* Added: Compatibility with WordPress 5.7
* Added: Compatibility with WooCommenrce 5.1

= WooDiscuz - WooCommerce Comments v2.2.7 =

* Text Domain naming issue. Make it compatible with WordPress Translation System

= WooDiscuz - WooCommerce Comments v2.2.6 =

* Added: Compatibility with WooCommenrce 4.5

= WooDiscuz - WooCommerce Comments v2.2.5 =

* Added: Compatibility with WooCommenrce 4.4
* Added: Compatibility with PHP 7.4

= WooDiscuz - WooCommerce Comments v2.2.4 =

* Added: WooCommerce 4 Compatibly
* Fixed: Problem with comment form CAPTCHA

= WooDiscuz - WooCommerce Comments v2.2.3 =

* Added: Compatibility with WordPress 5.3

= WooDiscuz - WooCommerce Comments v2.2.2 =

* Added: Compatibility with WordPress 5.2
* Added: Compatibility with WooCommenrce 3.6

= WooDiscuz - WooCommerce Comments v2.2.1 =

* Chnaged: Removing settings page slider

= WooDiscuz - WooCommerce Comments v2.2.0 =

* Added: Compatibility with WooCommenrce 3
* Changed: Stop replacing review comment type to  woodiscuz_ review

= WooDiscuz - WooCommerce Comments v2.1.0 =

* Fixed: WooCommerce >= 3.1.2 version compability
  woocommerce_product_review_count => woocommerce_product_get_review_count

= WooDiscuz - WooCommerce Comments v2.0.12 =

* Fixed: WooCommerce 3.0.x version compability

= WooDiscuz - WooCommerce Comments v2.0.11 =

* Changed: Deprecated function get_currentuserinfo() to wp_get_current_user()

= WooDiscuz - WooCommerce Comments v2.0.10 =

* Fixed Bug: Email notification issue when reply made from Dashboard > Comments admin page

= WooDiscuz - WooCommerce Comments v2.0.9 =
...
= WooDiscuz - WooCommerce Comments v1.1.6 =
...
= WooDiscuz - WooCommerce Comments v1.1.5 =
...
= WooDiscuz - WooCommerce Comments v1.1.4 =

* Fixed Bug: Problem with phrase saving.

= WooDiscuz - WooCommerce Comments v1.1.3 =
...
= WooDiscuz - WooCommerce Comments v1.1.2 =
...
= WooDiscuz - WooCommerce Comments v1.0.6 =
...
= WooDiscuz - WooCommerce Comments v1.0.2 =

Fixed Bug : CAPTCHA reloading issue with wp-content redirecting plugins.

= WooDiscuz - WooCommerce Comments v1.0.1 =
...
= WooDiscuz - WooCommerce Comments v1.0.0 =
