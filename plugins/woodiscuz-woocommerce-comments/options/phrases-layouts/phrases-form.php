<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('Form Template Phrases', 'woodiscuz-woocommerce-comments'); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Comment Field Start', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Comment Field Join', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Email Field', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Name Field', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('CAPTCHA Field', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Submit Button', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Notify on new replies (checkbox)', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">
                    <label for="wpc_notify_on_new_reply">
                        <input type="text" value="<?php echo isset($this->wpc_options_serialized->wpc_phrases['wpc_notify_on_new_reply']) ? $this->wpc_options_serialized->wpc_phrases['wpc_notify_on_new_reply'] : __('Notify of new replies to this comment','woodiscuz-woocommerce-comments'); ?>" name="wpc_notify_on_new_reply" id="wpc_notify_on_new_reply" />
                    </label>
                </td>
            </tr>
        </tbody>
