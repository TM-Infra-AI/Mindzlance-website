            ...
            <tr valign="top">
                ...
                <td colspan="3">                                
                    <label for="wpc_year_text_plural">
                        <input type="text" value="<?php echo isset($this->wpc_options_serialized->wpc_phrases['wpc_year_text_plural']['datetime'][0]) ? $this->wpc_options_serialized->wpc_phrases['wpc_year_text_plural']['datetime'][0] : __('Years', 'woodiscuz-woocommerce-comments'); ?>" name="wpc_year_text_plural" id="wpc_year_text_plural" />
                    </label>
                </td>
            </tr>
