            ...
            <tr valign="top">
                ...
                <td colspan="3">
                    <label for="wpc_unsubscribe">
                        <input type="text" name="wpc_unsubscribe" id="wpc_unsubscribe" class="wpc_unsubscribe" value="<?php echo $this->wpc_options_serialized->wpc_phrases['wpc_unsubscribe']; ?>" placeholder="<?php echo _e('Unsubscribe', 'woodiscuz-woocommerce-comments'); ?>"/>
                    </label>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td colspan="3">
                    <label for="wpc_confirm_email_subject">
                        <input type="text" name="wpc_confirm_email_subject" id="wpc_confirm_email_subject" class="wpc_confirm_email_subject" value="<?php echo isset($this->wpc_options_serialized->wpc_phrases['wpc_confirm_email_subject']) ? $this->wpc_options_serialized->wpc_phrases['wpc_confirm_email_subject'] : __('Subscribe Confirmation', 'woodiscuz-woocommerce-comments'); ?>" placeholder="<?php echo _e('Subscribe Confirmation', 'woodiscuz-woocommerce-comments'); ?>"/>
                    </label>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td colspan="3">
                    <label for="wpc_new_reply_email_subject">
                        <input type="text" value="<?php echo isset($this->wpc_options_serialized->wpc_phrases['wpc_new_reply_email_subject']) ? $this->wpc_options_serialized->wpc_phrases['wpc_new_reply_email_subject'] : _e('New Reply', 'woodiscuz-woocommerce-comments'); ?>" name="wpc_new_reply_email_subject" id="wpc_new_reply_email_subject" />
                    </label>
                </td>
            </tr>
