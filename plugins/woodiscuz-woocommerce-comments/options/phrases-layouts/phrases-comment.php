<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('Comment Template Phrases', 'woodiscuz-woocommerce-comments'); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Reply', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Share', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Edit', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Share On Facebook', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top" >
                <th scope="row">
                    <?php _e('Share On Twitter', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Share On Google', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Share On VKontakte', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Share On Odnoklassniki', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top" >
                <th scope="row">
                    <?php _e('Hide Replies', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Show Replies', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Title For Guests', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Title For Members', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Title For Customers', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Title For Support', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Vote Up', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Vote Down', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Save edited comment button text', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Cancel comment editing button text', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
