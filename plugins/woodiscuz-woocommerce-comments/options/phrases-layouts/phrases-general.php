<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('General Phrases', 'woodiscuz-woocommerce-comments'); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Disscussion Tab Title', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Header', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Load More Button', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
