<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('Notification Phrases', 'woodiscuz-woocommerce-comments'); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                <th scope="row">
                    <?php _e('Error message for empty field', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Error message for invalid email field', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('You must be', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Logged In', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('To post a comment', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Vote Counted', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('You can vote only 1 time', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Voting Error', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Login To Vote', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('You Cannot Vote On Your Comment', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Invalid Captcha Code', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Some of field value is invalid', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Comment waiting moderation', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Message if comment was not updated', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Message if comment no longer possible to edit', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('Message if comment text not changed', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">                                
            ...
            <tr valign="top">
                <th scope="row">
                    <?php _e('You\'ve successfully unsubscribed.', 'woodiscuz-woocommerce-comments'); ?>
                </th>
                <td colspan="3">
