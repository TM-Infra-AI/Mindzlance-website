...
class WPC_Options_Serialize {
     ...
     * Type - Input
     * Available Values - color codes
     * Description - Member Role Color
     * Default Value - #ad74a2
     */
    public $wpc_member_role_color;

    /*
     * Type - Input
     * Available Values - color codes
     * Description - Support Role Color
     * Default Value - #ad74a2
     */
    public $wpc_support_role_color;

    /*
     * Type - Input
     * Available Values - color codes
     * Description - Customer Role Color
     * Default Value - #ad74a2
     */
    public $wpc_customer_role_color;

    /*
     * Type - Input
     * Available Values - color codes
     * Description - Guest Role Color
     * Default Value - #ad74a2
     */
    public $wpc_guest_role_color;
    ...
    public function init_options($serialize_options) {
        ...
        $this->wpc_member_role_color = isset($options['wpc_member_role_color']) ? $options['wpc_member_role_color'] : '#ad74a2';
        $this->wpc_support_role_color = isset($options['wpc_support_role_color']) ? $options['wpc_support_role_color'] : '#ad74a2';
        $this->wpc_customer_role_color = isset($options['wpc_customer_role_color']) ? $options['wpc_customer_role_color'] : '#ad74a2';
        $this->wpc_guest_role_color = isset($options['wpc_guest_role_color']) ? $options['wpc_guest_role_color'] : '#ad74a2';
    ...
    public function init_phrases() {
        $this->wpc_phrases = array(
            'wpc_discuss_tab' => __('Discussions', 'woodiscuz-woocommerce-comments'),
            'wpc_header_text' => __('Got something to discuss?', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_start_text' => __('Start the discussion', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_join_text' => __('Join the discussion', 'woodiscuz-woocommerce-comments'),
            'wpc_email_text' => __('Email', 'woodiscuz-woocommerce-comments'),
            'wpc_name_text' => __('Name', 'woodiscuz-woocommerce-comments'),
            'wpc_captcha_text' => __('Please insert the code above to comment', 'woodiscuz-woocommerce-comments'),
            'wpc_submit_text' => __('Post Comment', 'woodiscuz-woocommerce-comments'),
            'wpc_load_more_submit_text' => __('Load More Comments', 'woodiscuz-woocommerce-comments'),
            'wpc_reply_text' => __('Reply', 'woodiscuz-woocommerce-comments'),
            'wpc_share_text' => __('Share', 'woodiscuz-woocommerce-comments'),
            'wpc_edit_text' => __('Edit', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_edit_cancel_button' => __('Cancel', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_edit_save_button' => __('Save', 'woodiscuz-woocommerce-comments'),
            'wpc_share_facebook' => __('Share On Facebook', 'woodiscuz-woocommerce-comments'),
            'wpc_share_twitter' => __('Share On Twitter', 'woodiscuz-woocommerce-comments'),
            'wpc_share_google' => __('Share On Google', 'woodiscuz-woocommerce-comments'),
            'wpc_share_vk' => __('Share On VKontakte', 'woodiscuz-woocommerce-comments'),
            'wpc_share_ok' => __('Share On Odnoklassniki', 'woodiscuz-woocommerce-comments'),
            'wpc_hide_replies_text' => __('Hide Replies', 'woodiscuz-woocommerce-comments'),
            'wpc_show_replies_text' => __('Show Replies', 'woodiscuz-woocommerce-comments'),
            'wpc_user_title_guest_text' => __('Guest', 'woodiscuz-woocommerce-comments'),
            'wpc_user_title_member_text' => __('Member', 'woodiscuz-woocommerce-comments'),
            'wpc_user_title_customer_text' => __('Customer', 'woodiscuz-woocommerce-comments'),
            'wpc_user_title_support_text' => __('Support', 'woodiscuz-woocommerce-comments'),
            'wpc_email_subject' => __('New Comment', 'woodiscuz-woocommerce-comments'),
            'wpc_email_message' => __('New comment on the product discussion section you\'ve been interested in', 'woodiscuz-woocommerce-comments'),
            'wpc_request_reply_subject' => __('Leave a Reply', 'woodiscuz-woocommerce-comments'),
            'wpc_request_reply_message' => __('Please, leave a reply on', 'woodiscuz-woocommerce-comments'),
            'wpc_error_empty_text' => __('please fill out this field to comment', 'woodiscuz-woocommerce-comments'),
            'wpc_error_email_text' => __('email address is invalid', 'woodiscuz-woocommerce-comments'),
            'wpc_year_text' => array('datetime' => array(__('year', 'woodiscuz-woocommerce-comments'), 1)),
            'wpc_year_text_plural' => array('datetime' => array(__('years', 'woodiscuz-woocommerce-comments'), 1)), // PLURAL
            'wpc_month_text' => array('datetime' => array(__('month', 'woodiscuz-woocommerce-comments'), 2)),
            'wpc_month_text_plural' => array('datetime' => array(__('months', 'woodiscuz-woocommerce-comments'), 2)), // PLURAL
            'wpc_day_text' => array('datetime' => array(__('day', 'woodiscuz-woocommerce-comments'), 3)),
            'wpc_day_text_plural' => array('datetime' => array(__('days', 'woodiscuz-woocommerce-comments'), 3)), // PLURAL
            'wpc_hour_text' => array('datetime' => array(__('hour', 'woodiscuz-woocommerce-comments'), 4)),
            'wpc_hour_text_plural' => array('datetime' => array(__('hours', 'woodiscuz-woocommerce-comments'), 4)), // PLURAL
            'wpc_minute_text' => array('datetime' => array(__('minute', 'woodiscuz-woocommerce-comments'), 5)),
            'wpc_minute_text_plural' => array('datetime' => array(__('minutes', 'woodiscuz-woocommerce-comments'), 5)), // PLURAL
            'wpc_second_text' => array('datetime' => array(__('second', 'woodiscuz-woocommerce-comments'), 6)),
            'wpc_second_text_plural' => array('datetime' => array(__('seconds', 'woodiscuz-woocommerce-comments'), 6)), // PLURAL
            'wpc_plural_text' => __('s', 'woodiscuz-woocommerce-comments'),
            'wpc_right_now_text' => __('right now', 'woodiscuz-woocommerce-comments'),
            'wpc_ago_text' => __('ago', 'woodiscuz-woocommerce-comments'),
            'wpc_posted_today_text' => __('today', 'woodiscuz-woocommerce-comments'),
            'wpc_you_must_be_text' => __('You must be', 'woodiscuz-woocommerce-comments'),
            'wpc_logged_in_text' => __('logged in', 'woodiscuz-woocommerce-comments'),
            'wpc_to_post_comment_text' => __('to post a comment.', 'woodiscuz-woocommerce-comments'),
            'wpc_vote_up' => __('Vote Up', 'woodiscuz-woocommerce-comments'),
            'wpc_vote_down' => __('Vote Down', 'woodiscuz-woocommerce-comments'),
            'wpc_vote_counted' => __('Vote Counted', 'woodiscuz-woocommerce-comments'),
            'wpc_vote_only_one_time' => __("You've already voted for this comment", 'woodiscuz-woocommerce-comments'),
            'wpc_voting_error' => __('Voting Error', 'woodiscuz-woocommerce-comments'),
            'wpc_login_to_vote' => __('You Must Be Logged In To Vote', 'woodiscuz-woocommerce-comments'),
            'wpc_self_vote' => __('You cannot vote for your comment', 'woodiscuz-woocommerce-comments'),
            'wpc_deny_voting_from_same_ip' => __('You are not allowed to vote for this comment', 'woodiscuz-woocommerce-comments'),
            'wpc_invalid_captcha' => __('Invalid Captcha Code', 'woodiscuz-woocommerce-comments'),
            'wpc_invalid_field' => __('Some of field value is invalid', 'woodiscuz-woocommerce-comments'),
            'wpc_held_for_moderate' => __('Your Comment awaiting moderation', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_not_updated' => __('Sorry, the comment was not updated', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_edit_not_possible' => __('Sorry, this comment no longer possible to edit', 'woodiscuz-woocommerce-comments'),
            'wpc_comment_not_edited' => __('You\'ve not made any changes', 'woodiscuz-woocommerce-comments'),
            'wpc_notify_on_new_reply' => __('Notify of new replies to this comment', 'woodiscuz-woocommerce-comments'),
            'wpc_confirm_email_subject' => __('Subscribe Confirmation', 'woodiscuz-woocommerce-comments'),
            ...
            'wpc_confirm_email' => __('Confirm Subscription', 'woodiscuz-woocommerce-comments'),
            'wpc_ignore_subscription' => __('Ignore Subscription', 'woodiscuz-woocommerce-comments'),
            'wpc_unsubscribe_message' => __('You\'ve successfully unsubscribed.', 'woodiscuz-woocommerce-comments'),
            'wpc_confirm_success_message' => __('You\'ve successfully confirmed your subscription.', 'woodiscuz-woocommerce-comments'),
            'wpc_unsubscribe' => __('Unsubscribe', 'woodiscuz-woocommerce-comments'),
            'wpc_new_reply_email_subject' => __('New Reply', 'woodiscuz-woocommerce-comments'),
            'wpc_new_reply_email_message' => __('New reply on the discussion section you\'ve been interested in', 'woodiscuz-woocommerce-comments'),
        );
    }
    ...
    public function to_array() {
        $options = array(
            ...
            'wpc_member_role_color' => $this->wpc_member_role_color,
            'wpc_support_role_color' => $this->wpc_support_role_color,
            'wpc_customer_role_color' => $this->wpc_customer_role_color,
            'wpc_guest_role_color' => $this->wpc_guest_role_color,
    ...
    public function add_options() {
        $options = array(
            ...
            'wpc_member_role_color' => '#ad74a2',
            'wpc_support_role_color' => '#ad74a2',
            'wpc_customer_role_color' => '#ad74a2',
            'wpc_guest_role_color' => '#ad74a2',
            'wpc_is_use_po_mo' => '0',
