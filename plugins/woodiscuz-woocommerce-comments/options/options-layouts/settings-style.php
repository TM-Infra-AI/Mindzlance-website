    ...
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td width="1">
                    <input type="text" class="regular-text" value="<?php echo isset($this->wpc_options_serialized->wpc_form_bg_color) ? $this->wpc_options_serialized->wpc_form_bg_color : '#f9f9f9'; ?>" id="wpc_form_bg_color" name="wpc_form_bg_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td width="1">
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_comment_bg_color; ?>" id="wpc_comment_bg_color" name="wpc_comment_bg_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-dark">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_reply_bg_color; ?>" id="wpc_reply_bg_color" name="wpc_reply_bg_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_comment_text_color; ?>" id="wpc_comment_text_color" name="wpc_comment_text_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_member_role_color; ?>" id="wpc_member_role_color" name="wpc_member_role_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_support_role_color; ?>" id="wpc_support_role_color" name="wpc_support_role_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_customer_role_color; ?>" id="wpc_customer_role_color" name="wpc_customer_role_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
            ...
            <tr valign="top" class="wpc-row-light">
                ...
                <td>
                    <input type="text" class="regular-text" value="<?php echo $this->wpc_options_serialized->wpc_guest_role_color; ?>" id="wpc_guest_role_color" name="wpc_guest_role_color" placeholder="<?php _e('Example: #00ff00', 'woodiscuz-woocommerce-comments'); ?>"/>
                </td>
                <td class="picker_img_cell">
