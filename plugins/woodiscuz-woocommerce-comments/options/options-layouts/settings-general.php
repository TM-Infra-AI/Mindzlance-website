    ...
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>
            <tr valign="top">
                ...
                <td colspan="2"><input type="number" value="<?php echo isset($this->wpc_options_serialized->wpc_comment_tab_priority) ? $this->wpc_options_serialized->wpc_comment_tab_priority : 1000 ?>" name="wpc_comment_tab_priority" id="wpc_comment_tab_priority" /></td>
            </tr>
            <tr valign="top">
