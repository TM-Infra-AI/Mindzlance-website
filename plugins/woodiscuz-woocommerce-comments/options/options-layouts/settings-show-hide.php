<div>
    <h2 style="padding:5px 10px 10px 10px; margin:0px;"><?php _e('Show/Hide Components', 'woodiscuz-woocommerce-comments'); ?></h2>
    <table class="wp-list-table widefat plugins"  style="margin-top:10px; border:none;">
        <tbody>          
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_tab_show_hide"><?php _e('Hide WooCommerce Review Tab', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_voting_buttons_show_hide"><?php _e('Hide Voting buttons', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_share_buttons_show_hide"><?php _e('Hide Share Button', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_captcha_show_hide"><?php _e('Hide the  CAPTCHA field', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_reply_button_guests_show_hide"><?php _e('Hide Reply button for Guests', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_reply_button_customers_show_hide"><?php _e('Hide Reply button for Customers', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_author_titles_show_hide"><?php _e('Hide Author Titles', 'woodiscuz-woocommerce-comments'); ?></label></th>
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;"><label for="wpc_reply_subscription_on_off"><?php _e('Hide Subscription', 'woodiscuz-woocommerce-comments'); ?></label></th>
