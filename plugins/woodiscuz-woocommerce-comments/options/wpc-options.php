...
class WPC_Options {
    ...
    public function main_options_form() {
        ...
        if (isset($_POST['wpc_submit_options'])) {
            ...
            $this->wpc_options_serialized->wpc_member_role_color = isset($_POST['wpc_member_role_color']) ? $_POST['wpc_member_role_color'] : '#ad74a2';
            $this->wpc_options_serialized->wpc_support_role_color = isset($_POST['wpc_support_role_color']) ? $_POST['wpc_support_role_color'] : '#ad74a2';
            $this->wpc_options_serialized->wpc_customer_role_color = isset($_POST['wpc_customer_role_color']) ? $_POST['wpc_customer_role_color'] : '#ad74a2';
            $this->wpc_options_serialized->wpc_guest_role_color = isset($_POST['wpc_guest_role_color']) ? $_POST['wpc_guest_role_color'] : '#ad74a2';
