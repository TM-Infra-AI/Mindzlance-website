...
== Description ==
This plugin use for wordpress comments js validation to the comment form. Option for set your own validation message and Option for Add Google Captcha (reCAPTCHA)
